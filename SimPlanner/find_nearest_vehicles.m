function [z_neighboring, speeds_neighboring] = find_nearest_vehicles(t, x_ego, y_ego, x_car_simulated, y_car_simulated, vx, Ts)
    % FIND_NEAREST_VEHICLES Finds the positions and speeds of the three nearest vehicles to the ego vehicle.
    % Usage:
    %   [z_neighboring, speeds_neighboring] = find_nearest_vehicles(t, x_ego, y_ego, x_car_simulated, y_car_simulated, vx, Ts)
    %
    % Inputs:
    %   t: Current time
    ...
    %   Ts: Time step used to generate simulated data
    %
    % Outputs:
